...
namespace SwiftRoomAPI.Repository
{
    public class AuthManager : IAuthManager
    {
        ...
        private const string _loginProvider = "SwiftRoomApi"; // provider and issuers
        private const string _refreshToken = "RefreshToken"; // string tokenname
        ...
        private async Task<string> GenerateToken()
        {
            ...
            {
                new Claim(JwtRegisteredClaimNames.Sub, _user.Email),// the person to who the token has been issued
